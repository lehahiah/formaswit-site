        ...
        <section className="pt-20 lg:pt-24 section-padding bg-white">
          <div className="container max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p>
                <strong>FormaSwift</strong><br />
                Société par actions simplifiée au capital de 10 000 €<br />
                Siège social : {SITE_CONFIG.contact.address}<br />
              ...
              <p>
                Sarah Martin, en qualité de Directrice Générale.
              </p>

              <h3>Contact</h3>
              <p>
                Email : {SITE_CONFIG.contact.email}<br />
                Téléphone : {SITE_CONFIG.contact.phone}
              </p>
