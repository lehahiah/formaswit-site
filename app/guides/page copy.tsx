        ...
        <section className="section-padding bg-gray-50">
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-700 max-w-2xl mx-auto">
                Des ressources complètes et professionnelles pour aller plus loin
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {paidProducts.map((product) => {
                const formatInfo = productFormats.find(f => f.title === product.category);
                const IconComponent = formatInfo?.icon || FileText;
                const colorClass = formatInfo?.color || 'bg-gray-100 text-gray-700';
                ...
                return (
                  <div
                    key={product.id}
                    className={`bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border-2 ${
                      product.featured ? 'border-secondary/50' : 'border-gray-100'
                    } hover:border-accent/30 relative`}
                  >
                    {product.featured && (
                      ...
                      <div className="flex items-center justify-between mt-6">
                        ...
                        {isAvailable ? (
                          <a
                            ...
                            className="bg-secondary hover:bg-secondary/90 text-white font-semibold px-4 py-2 rounded-lg transition-colors duration-300 flex items-center space-x-2"
                          >
                          ...
                          <div className="bg-gray-100 text-gray-500 font-medium px-4 py-2 rounded-lg flex items-center space-x-2">
